...
struct Integrator_parameters_type {
    ...
    /*! @brief The adaptive RK7(8) error threshold parameter. Right now, this is used as both an absolute and relative thresholds. */
    double RK_78_abs_accuracy;

    /*! @brief The adaptive RK7(8) error threshold parameter. Right now, this is used as both an absolute and relative thresholds. */
    double RK_78_rel_accuracy;

    /*! @brief The adaptive ESDIRK5(4) error threshold parameter. Right now, this is used as both an absolute and relative thresholds. */
...
struct Initial_conditions_type {
    ...
    /*! @brief Integer that specifies the currently active simulation mode. */
    int Simulation_mode;
    ...
    /*! @brief Boolean flag that controls weather to simply add the hotspot and disk density and temperature
...
struct Results_type {
    ...
    /*! @brief Array that holds the photon momentum at the source from the Page-Thorne dis.
       This exists for use in simulation mode 2. */
