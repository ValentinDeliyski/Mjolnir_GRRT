...
Sim_image_230 = eh.image.load_txt('Ehtim_Input_Data/Wormhole_data_for_ehtim_230.csv')
Sim_image_345 = eh.image.load_txt('Ehtim_Input_Data/Wormhole_data_for_ehtim_345.csv')
...
obs230_chi_amp = obs230.chisq(out345_mf, ttype = 'fast', dtype = 'amp')

obs345_chi_cphase = obs345.chisq(out345_mf, ttype = 'fast', dtype = 'cphase')
obs230_chi_cphase = obs230.chisq(out345_mf, ttype = 'fast', dtype = 'cphase')
...
if (len(msg1) < msg_len):
    print("|" + msg1 + " " * (msg_len - len(msg1)) + "|")
else:
    print("|" + msg1 + "|")

if (len(msg2) < msg_len):
    print("|" + msg2 + " " * (msg_len - len(msg2)) + "|")
else:
    print("|" + msg2 + "|")
