    ...
    for tv_multiplier in [100, 10, 1]:
        ...
        for l1_multiplier in [0, 10, 1, 100]:
            ...
            for fwhm in [50]:
                ...
                for total_flux in [0.5]:
                    
                    for FOV_mult in [1.2]:
                  
                        Simulation_name = "Sim_Paper_1_follow_up/run_3/Sch/Sch_ngEHT_simple_{}_tv_{}_l1_{}_fwhm_{}_tot_flux_{}_fov_mult_{}".format(simple_multiplier, tv_multiplier, l1_multiplier, fwhm, total_flux, FOV_mult)
                        ...
                        Sim_image_230 = eh.image.load_txt('C:\\Users\\Valur\\Documents\\Repos\\Mjolnir_GRRT\\Utilities\\Ehtim\\Ehtim_Input_Data\\Sch_data_for_ehtim_230.csv')
                        Sim_image_345 = eh.image.load_txt('C:\\Users\\Valur\\Documents\\Repos\\Mjolnir_GRRT\\Utilities\\Ehtim\\Ehtim_Input_Data\\Sch_data_for_ehtim_345.csv')
