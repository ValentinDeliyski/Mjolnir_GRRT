...
Simulation_name = "Wormhole_EHT2022"

# Load the image and the array
im  = eh.image.load_txt('Ehtim_Input_Data/Wormhole_data_for_ehtim_230.csv')
eht = eh.array.load_txt('Ehtim_Input_Data/arrays/EHT2022.txt')
