...
class Simulation:
    ...
    def __init__(self):
        ...
        self.Sim_config.metric_parameters.Numerical_metric_spline_path = "C:/Users/Valur/Documents/Repos/Mjolnir_GRRT/Utilities/Galin_numerical_config_I.XML"
        ...
        self.Sim_config.metric_parameters.Mass           = {"Value": 0.915671, "Unit": "[M]"}
        self.Sim_config.metric_parameters.Horizon_radius = {"Value": 0.05, "Unit": "[G/c^2]"}
        self.Sim_config.metric_parameters.Spin           = {"Value": 0.8048 / 0.915671, "Unit": "[M]"}
        ...
        self.Sim_config.observer.Resolution_x = {"Value": 2048, "Unit": "[-]"}
        self.Sim_config.observer.Resolution_y = {"Value": 2048, "Unit": "[-]"}
        
        self.Sim_config.observer.Distance    = {"Value": 1e4, "Unit": "[M]"}
        self.Sim_config.observer.Inclination = {"Value": 20 * pi / 180, "Unit": "[Rad]"}
        ...
        self.Sim_config.integrator.RK78_accuracy      = {"Value": 1e-14, "Unit": "[-]"}
        self.Sim_config.observer.Include_polarization = {"Value": 0, "Unit": "[-]"}
        
        # self.Sim_config.integrator.Step_controller_type  = {"Value": "PID", "Unit": "[-]"}
        self.Sim_config.integrator.max_integration_count = {"Value": 100000, "Unit": "[-]"}
        self.Sim_config.integrator.max_affine_parameter  = {"Value": 100000, "Unit": "[-]"}
        
        self.Sim_config.metric_parameters.Distance_to_singular_point = {"Value": 1e-2, "Unit": "[M]"}
        
        self.Sim_config.integrator.Max_rel_step_increase = {"Value": 2, "Unit": "[-]"}
        ...
        self.Sim_config.integrator.radiative_transfer_integrator_type = {"Value": "RK5", "Unit": "[-]"}
        # ================================================== Hotspot ================================================== #
    ...
    def run_simulation(self):
        ...
        self.Sim_config.observer.Image_y_min = {"Value": -15.0, "Unit": "[M]"}
        self.Sim_config.observer.Image_y_max = {"Value":  15.0, "Unit": "[M]"}
        self.Sim_config.observer.Image_x_min = {"Value": -15.0, "Unit": "[M]"}
        self.Sim_config.observer.Image_x_max = {"Value":  15.0, "Unit": "[M]"}
            
        """ The simulation output file path """
        self.Sim_config.file_manager.Output_file_directory = parent_directory + "Reference_simulations"
        self.Sim_config.simulation_name = {"Value": "Galin_Numerical_config_I_5", "Unit": "[-]"}
        self.Sim_config.generate_simulation_input(Path_to_input_dir = "Reference_simulations\\Galin_Numerical_config_I_5",
                                                  Input_file_name = "Galin_Numerical_config_I_5.XML")
        filename = "C:\\Users\\Valur\\Documents\\Repos\\Mjolnir_GRRT\\Utilities\\Reference_simulations\\Galin_Numerical_config_I_5\\Galin_Numerical_config_I_5.xml"
...
if __name__ == "__main__":
    ...
    Sim_thread = threading.Thread(target = Simulation_instance.run_simulation, args = [])
    Sim_thread.start()
