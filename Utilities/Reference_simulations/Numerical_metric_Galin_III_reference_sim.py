...
class Simulation:
    ...
    def __init__(self):
        ...
        self.Sim_config.observer.Resolution_x = {"Value": 512, "Unit": "[-]"}
        self.Sim_config.observer.Resolution_y = {"Value": 256, "Unit": "[-]"}
    ...
    def run_simulation(self):
        ...
        self.Sim_config.observer.Image_y_min = {"Value": -0.0, "Unit": "[M]"}
        ...
        self.Sim_config.simulation_name = {"Value": "Galin_Numerical_config_III_5_345", "Unit": "[-]"}
        
        self.Sim_config.generate_simulation_input(Path_to_input_dir = "Reference_simulations\\Galin_Numerical_config_III_5_345",
                                                  Input_file_name = "Galin_Numerical_config_III_5_345.XML")
        
        filename = "C:\\Users\\Valur\\Documents\\Repos\\Mjolnir_GRRT\\Utilities\\Reference_simulations\\Galin_Numerical_config_III_5_345\\Galin_Numerical_config_III_5_345.xml"
