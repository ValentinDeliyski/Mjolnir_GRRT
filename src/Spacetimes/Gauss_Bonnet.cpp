...
Return_Values Gauss_Bonnet_class::load_parameters(const Metric_parameters_type* const p_Metric_Parameters) {
    ...
    if (isnan(p_Metric_Parameters->GB_Gamma_Parameter) || isinf(p_Metric_Parameters->GB_Gamma_Parameter) || p_Metric_Parameters->GB_Gamma_Parameter < 0) {

        std::cout << "Invalid value for the gamma parameter: " << p_Metric_Parameters->GB_Gamma_Parameter << "\n";
